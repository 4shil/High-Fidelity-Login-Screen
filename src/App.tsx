...
import { Eye, EyeOff, Moon, Sun, ArrowRight, GraduationCap, Users } from 'lucide-react';
          ...
          <div className={`text-center mt-4 pt-4 border-t ${isDark ? 'border-white/10' : 'border-gray-300/30'}`}>
            ...
            >
              <span className="relative">
                {isTeacherLogin ? 'Login as Student' : 'Login as Teacher'}
